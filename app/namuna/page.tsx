    ...
    <>
      ...
      <main>
        ...
        <Chapter
          ...
          lead="Кухни, гардеробные и корпусная мебель с наших объектов. Подписано только то, что видно на кадре: тип мебели и материалы."
        >
          <Projects />
        </Chapter>
        ...
        <Chapter
          ...
          tone="deep"
          title={<DeepTitle>Почему наша мебель стоит столько, сколько стоит</DeepTitle>}
          lead="Шесть наших доводов, каждый из которых виден в смете строкой — и через несколько лет в том, как открываются ящики."
        >
          <Production />
        ...
        <Chapter
          ...
          title={
            <>
              Работаем с теми, чьё имя <span className="nm-accent">стоит на петле</span>
            </>
          }
          lead="Сначала те, чьи петли, плита и техника стоят внутри нашей мебели. Следом — жилые комплексы, которые мы меблировали целиком."
        >
          <Partners />
        </Chapter>
