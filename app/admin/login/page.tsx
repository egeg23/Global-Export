...
export default async function LoginPage() {
  // На площадке входа нет вовсе: панель открывается сама. Ссылка сюда могла
  // остаться в закладке у заказчика — ведём его прямо в панель.
  if (isShowcase) redirect("/admin");
