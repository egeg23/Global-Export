    ...
    <>
      ...
      <main>
        ...
        <Chapter
          ...
          lead="Двадцать одно направление из их каталога. Выбор цели и суммы сразу пересчитывает список: остаются те страны, где на эти деньги что-то действительно покупают."
        >
          <Search />
        </Chapter>
        ...
        <Chapter
          ...
          lead="Строительство в Европе, строительство в Дубае, реновация и арендный бизнес. Их доходности стоят на главной строкой — здесь из этой строки выходит сумма и срок."
        >
          <Strategies />
        </Chapter>
        ...
        <Chapter
          ...
          lead="Присутствие на карте, а не строкой в подвале: города стоят на своих настоящих координатах, дуги идут от Москвы, откуда компания родом."
        >
          <OfficeMap />
        </Chapter>
        ...
        <Chapter
          ...
          lead="Десять программ из их блока «Гражданство и ВНЖ» — от вида на жительство цифрового кочевника до гражданства за инвестиции. Сортируются по сроку оформления."
        >
          <Permits />
        </Chapter>
        ...
        <Chapter
          ...
          lead="Инвестиционная группа внутри компании — тот довод, который отличает их от брокера объявлений."
        >
          <Capital />
        </Chapter>
        ...
        <Chapter
          ...
          lead="База знаний по каждой стране: налоги, ипотека, содержание, районы. На нынешнем сайте это список ссылок в подвале."
        >
          <Analytics />
        </Chapter>
        ...
        <Chapter
          ...
          lead="Цена нашей работы, а не что-то со стороны Tranio. Любой блок снимается тумблером — и сумма сразу становится другой."
        >
          <Offer
            items={trOffer}
            currency="rub"
            title="Стоимость макета"
            lead="Полный состав: главная со всеми механиками и панель управления"
            fullLabel="Полный состав —"
            note="Срок — три недели от согласования. В цену входят вёрстка, адаптив от 320 px, выкатка на домен и SSL. Хостинг и домен оплачиваются отдельно и напрямую."
          />
        </Chapter>
