...
export default async function PresentPage() {
  ...
  const stops: Stop[] = [
    ...
    },
    {
      ...
      text: "Подарочные наборы, adar.uz. Три варианта главной страницы: витрина, каталог с поиском по составу и премиальная версия. Отдельный проект — открывается в своём оформлении.",
    ...
    },
    {
      ...
      text: "Застройщик, mavera.uz. Три рабочих сайта: строгий каталог, журнальный разворот и светлый премиум с генпланом, подбором квартиры и тремя палитрами на выбор. Со сметой по каждому.",
      note: "Переключатель проектов — вверху страницы",
    },
    {
