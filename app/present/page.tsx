...
export default async function PresentPage() {
  ...
  const stops: Stop[] = [
    ...
    },
    {
      ...
      text: "Застройщик, mavera.uz. Три рабочих сайта: строгий каталог, журнальный разворот и кинематографичный премиум с генпланом и подбором квартиры. Со сметой по каждому.",
      note: "Переключатель проектов — вверху страницы",
    },
    {
