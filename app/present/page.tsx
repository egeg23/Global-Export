...
export default async function PresentPage() {
  ...
  const stops: Stop[] = [
    ...
    },
    {
      ...
      eyebrow: "Анимация",
      title: "Полёт урожая",
      text: "Ответ на вопрос про анимации уровня loeschs.de. Сухофрукты выходят в кадр, к ним подхватываются орехи, всё раскладывается по корзинам — и ниже разбор, сколько строк кода занимает каждый приём.",
      external: true,
    },
    {
      href: "/ru/concept-a",
    ...
    },
    {
      ...
      text: "Подарочные наборы, adar.uz. Три варианта главной страницы с составом работ по каждому: витрина, каталог с поиском по составу и премиальная версия. Отдельный проект — открывается в своём оформлении.",
      note: "Переключатель проектов — вверху страницы",
    },
    {
      href: "/mavera",
      eyebrow: "Третий проект",
      title: "MAVERA — три варианта сайта",
      text: "Застройщик, mavera.uz. Три рабочих сайта: строгий каталог, журнальный разворот и светлый премиум с генпланом, подбором квартиры и тремя палитрами на выбор. С составом работ по каждому.",
      note: "Переключатель проектов — вверху страницы",
    },
    {
