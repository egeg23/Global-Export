...
/**
 * Отсчёт с 2011-го: этот год компания называет сама и печатает на пакетах
 * — «SINCE 2011». Более ранние сезоны появятся, если заказчик их добавит.
 */
const FIRST = 2011;
const LAST = 2026;
...
const notes: Record<number, string> = {
  2011: "Первый сезон. 24 000 подарков Алмалыкскому комбинату",
