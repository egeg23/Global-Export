    ...
    <div ref={stage} className="grid gap-10">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
          ...
          <fieldset>
            ...
            <p className="mt-2 text-[0.78rem] text-[var(--w-muted)]">
              От €70 тыс. — порог входа их инвестиционных стратегий
            </p>
          </fieldset>
        </div>
      </div>
      ...
      {found.length === 0 ? (
        <p className="text-[0.94rem] leading-relaxed text-[var(--w-muted)]">
          ...
          у них 10 офисов и партнёры в тех странах, которых нет в этом списке.
        </p>
      ) : (
      ...
      <p className="text-[0.78rem] leading-relaxed text-[var(--w-muted)]">
        Страны, города и фотографии — с их сайта. Порог входа по направлению —
        ориентир по рынку, а не прайс Tranio: собственного прайса по странам
        они не публикуют. Доходности не выходят за границы их четырёх
        стратегий. В рабочем сайте эта таблица приходит из панели управления.
      </p>
    </div>
  );
}
