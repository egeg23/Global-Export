    ...
    <div ref={stage} className="grid gap-10 lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)] lg:gap-14">
      ...
      <div>
        ...
        <p className="mt-6 text-[0.78rem] leading-relaxed text-[var(--w-muted)]">
          Пороги и список программ — их, из блока «Гражданство и ВНЖ»: ВНЖ ЕС
          от €250 тыс., ВНЖ ОАЭ от $205 тыс., гражданство Турции, Египта,
          Вануату и стран Карибского бассейна. Сроки оформления они не
          публикуют — здесь они типовые по программам и нужны только для
          сортировки.
        </p>
      </div>
    </div>
