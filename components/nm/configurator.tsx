    ...
    >
      ...
      {sent ? (
        ...
        >
          ...
          состав целиком: тип мебели, объём, материалы, фурнитура, вилка цены и
          срок, — и менеджер перезванивает, уже зная, о чём речь.
        </p>
      ) : (
      ...
      <p className="mt-6 text-[0.76rem] leading-relaxed text-[var(--w-muted)]">
        Цены в калькуляторе — ориентир по рынку, разложенный по материалам и
    ...
    <div className="mt-7 border-t border-[var(--w-line)] pt-5">
      ...
      {miss ? (
        <p role="status" className="mt-3 text-[0.8rem] text-[var(--w-muted)]">
          ...
          исполнении. Уменьшите метраж выше — или позвоните, у фабрики бывают
