  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ "--w-depth": "150px", "--w-pull": "8px" } as React.CSSProperties}
      >
        <Image
      ...
      <div
        ...
        style={{ "--w-depth": "110px", "--w-pull": "14px" } as React.CSSProperties}
      >
        Namuna
      </div>
      ...
      <div className="mx-auto grid w-full max-w-[1500px] items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        ...
        <div
          className="w-layer"
          style={{ "--w-depth": "-54px", "--w-pull": "-14px" } as React.CSSProperties}
        >
        ...
        <div
          ...
          style={{ "--w-depth": "-130px", "--w-pull": "26px" } as React.CSSProperties}
        >
 ...
 *
 * Ни счётчик, ни его видимость не хранятся в состоянии React: счётчик сам
 * наблюдает за своим узлом и пишет в него текст. Состояние здесь дало бы
 * шестьдесят перерисовок в секунду на каждую цифру и ничего больше.
 */
  ...
  useEffect(() => {
    ...
    const run = () => {
      ...
      const draw = (now: number) => {
        ...
        const progress = Math.min(Math.max((now - start) / 1400, 0), 1);
        node.textContent = String(Math.round(to * (1 - (1 - progress) ** 3)));
