 ...
 * попало в браузер, скопировать можно, а витрина открыта всем, у кого есть
 * ссылка. Здесь — метка в консоли для тех, кто туда всё-таки заглянул.
 */
