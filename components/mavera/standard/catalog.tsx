 ...
 *
 * Фильтр один — по сегменту, ровно как в составе «Стандарта». Статусы,
 * сортировка и поиск по нескольким параметрам — уже «Люкс»: базовый вариант
 * должен и выглядеть, и уметь проще следующего.
 */
