      ...
      <main className="min-h-screen bg-[#0b0d10] pb-28 text-sand-50">
        <Container className="pt-14">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-sand-200/75">
            Три экрана — «Корпуса и квартиры», «Карточка ЖК» и «Заявки» — работают
            по-настоящему: выделяйте квартиры, меняйте цену и статус, переключайте
            языки, ведите заявку по воронке. Они отмечены точкой в списке слева.
            Остальные показывают вид.
          </p>
        </Container>
