      ...
      <div>
        ...
        <p className="mt-4 text-[0.78rem] leading-relaxed text-[var(--w-muted)]">
          {t({
            ...
            kk: `Схемада филиалдар арасындағы ${links.length} негізгі иық, жалпы ұзындығы ${shownKm.toLocaleString("ru-RU")} км. Магистраль теміржол бойымен жүреді: біз ҚТЖ-дан бөлініп шыққан компаниямыз.`,
          })}
        </p>
      </div>
    </div>
