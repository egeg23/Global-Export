  ...
  return (
    ...
    >
      ...
      <p className="mt-6 text-[0.78rem] leading-relaxed text-[var(--w-muted)]">
        {t({
          ru: `Цены — ориентир по рынку корпоративной связи Казахстана, а не тариф «Транстелекома»: прайса они не публикуют. Счёт идёт на ${seats} рабочих мест. В рабочем сайте таблица приходит из панели управления.`,
          kk: `Бағалар — Қазақстандағы корпоративтік байланыс нарығының бағдары, «Транстелеком» тарифі емес: прайсты олар жарияламайды. Есеп ${seats} жұмыс орнына жүргізіледі. Жұмыс сайтында кесте басқару панелінен келеді.`,
        })}
      </p>
    </div>
  );
